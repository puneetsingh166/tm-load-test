...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/onomyprotocol/tm-load-test/customclient/types/errors.Wrap",
		"github.com/onomyprotocol/tm-load-test/customclient/types/errors.Wrapf",
		"github.com/onomyprotocol/tm-load-test/customclient/types/errors.WithType",
