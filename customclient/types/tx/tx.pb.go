...
import (
	...
	types1 "github.com/onomyprotocol/tm-load-test/customclient/crypto/types"
	...
	signing "github.com/onomyprotocol/tm-load-test/customclient/types/tx/signing"
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/onomyprotocol/tm-load-test/customclient/issues/9122).
