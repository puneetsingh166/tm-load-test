...
import (
	...
	vestexported "github.com/onomyprotocol/tm-load-test/customclient/x/auth/vesting/exported"
...
func (k BaseViewKeeper) IterateAllBalances(ctx sdk.Context, cb func(sdk.AccAddress, sdk.Coin) bool) {
	...
	for ; iterator.Valid(); iterator.Next() {
		...
		if err != nil {
			...
			// ref: https://github.com/onomyprotocol/tm-load-test/customclient/issues/7409
			panic(err)
		}
