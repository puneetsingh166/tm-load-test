...
// https://github.com/onomyprotocol/tm-load-test/customclient/blob/v0.40.1/x/staking/types/genesis.pb.go
...
import (
	...
	github_com_cosmos_cosmos_sdk_types "github.com/onomyprotocol/tm-load-test/customclient/types"
...
type GenesisState struct {
	...
	LastTotalPower github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=last_total_power,json=lastTotalPower,proto3,customtype=github.com/onomyprotocol/tm-load-test/customclient/types.Int" json:"last_total_power" yaml:"last_total_power"`
