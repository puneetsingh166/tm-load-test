...
import (
	...
	"github.com/onomyprotocol/tm-load-test/customclient/x/staking/keeper"
...
func TestSlashWithUnbondingDelegation(t *testing.T) {
	...
	// this may not be the desirable behaviour, ref https://github.com/onomyprotocol/tm-load-test/customclient/issues/1440
	ctx = ctx.WithBlockHeight(13)
	app.StakingKeeper.Slash(ctx, consAddr, 9, 10, fraction)
