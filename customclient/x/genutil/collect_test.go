...
import (
	...
	gtypes "github.com/onomyprotocol/tm-load-test/customclient/x/genutil/types"
)
...
// a directory during traversal of the first level. See issue https://github.com/onomyprotocol/tm-load-test/customclient/issues/6788.
