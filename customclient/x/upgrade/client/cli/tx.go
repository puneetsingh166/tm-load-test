...
import (
	...
	"github.com/onomyprotocol/tm-load-test/customclient/x/gov/client/cli"
	gov "github.com/onomyprotocol/tm-load-test/customclient/x/gov/types"
	"github.com/onomyprotocol/tm-load-test/customclient/x/upgrade/types"
)
...
func NewCmdSubmitUpgradeProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Submit a software upgrade along with an initial deposit.\n" +
			...
			"You may include info to reference a binary download link, in a format compatible with: https://github.com/onomyprotocol/tm-load-test/customclient/tree/master/cosmovisor",
